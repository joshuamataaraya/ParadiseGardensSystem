...
public class LoginTwitterController extends Activity {
    ...
    private static final String TWITTER_KEY = "w8XZJ1WM813RouE1LtwbhGBDj";
    private static final String TWITTER_SECRET = "KUxIAEqeNzjjcOnheC6zhjwBa2wFlDyqr3741k2ocg0C5gHgPc";
